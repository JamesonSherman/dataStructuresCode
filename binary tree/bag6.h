...
// https://www.cs.colorado.edu/~main/chapter10/bag6.h:
...
namespace main_savitch_10
{
	...
	private:
		...
		std::stack<binary_tree_node<Item>*> s; //*** "a stack of pointers to nodes"
		
		void inorder_push(binary_tree_node<Item> *r); // *** "use an inorder traversal to push node pointers onto the stack" 
