// FILE: main.cpp (for CSC 307 Spring 2018 HW 3)
// An interactive test program for the sorted sequence class,
...
void show_sequence(sorted_sequence display);
...
int main()
{
	sorted_sequence test; // A sorted sequence that we’ll perform tests on
